package nodomain.jsongenerator.exceptions;
...
public class Errors {
	...
	public static final String INVALID_PRECISION = "Precision is less than 0!";
	public static final String INVALID_PATTERN_LENGHT = "Pattern is shorter than 1 character!";
	public static final String INVALID_STRING_PATTERN = "Given pattern cannot be converted to numbers!";
	public static final String INVALID_LENGTH_SIZE = "Lenght is smaller than 1!";
	public static final String FIRST_AND_ALL = "Selected both first capital and all capital options!";
	public static final String INVALID_COUNT = "Count is less than 1!";
}
